...
export default function App() {
  ...
  return (
    <div className="fixed inset-0 bg-[#070707] flex items-center justify-center p-0 md:p-4 selection:bg-[#FFF000] selection:text-black">
      ...
      <div 
        className={`relative w-full h-full md:aspect-[600/1300] md:h-auto md:max-h-[100vh] md:max-w-[600px] md:rounded-[2rem] md:border-8 md:border-[#1a1a1a] shadow-[0_0_100px_rgba(0,0,0,0.8)] overflow-hidden font-sans touch-none ${isShaking ? 'shake' : ''}`}
